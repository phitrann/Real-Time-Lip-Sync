...
import copy
import json
from rtlipsync.utils.utils import get_file_type,get_video_fps,datagen
from rtlipsync.utils.preprocessing import get_landmark_and_bbox,read_imgs,coord_placeholder
from rtlipsync.utils.blending import get_image,get_image_prepare_material,get_image_blending
from rtlipsync.utils.utils import load_all_model
import shutil
...
if __name__ == "__main__":
    '''
    This script is used to simulate online chatting and applies necessary pre-processing such as face detection and face parsing in advance. During online chatting, only UNet and the VAE decoder are involved, which makes rtlipsync real-time.
    '''
